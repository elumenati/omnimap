...
public:
	...
	void appendsimpVec( const simpVec& v);
	...
	void simMatrix_PUT_OPEN_GL( int _rows, int _cols, const float *_vals );

	void simMatrix_GET_OPEN_GL( int  &_rows, int  &_cols,  float *_vals );
