...
OM_CylinderScreen::OM_CylinderScreen()
{
  ...
  iTessel = 100;
  SetUpPropertyAccess();
  EH_Log("new OmniMap_Screen:OM_CylinderScreen");
...
{
  EH_DECLARE;
  EH_Log("delete OmniMap_Screen:OM_CylinderScreen");
...
bool OM_CylinderScreen::CreateGeometry()
{
  ...
  EH_Ptr(vertexCounts = new int[(iTessel+1)]);
  numShapes = 0;
...
{
  EH_DECLARE;
  EH_Log("derived OM_CylinderScreen::SetUpPropertyAccess()");
