...
#define OMNIMAP_DEFAULT_SHADER_VERTEXSHADER "OmniMapDome11.fx"
 ...
 *	</ul>
 */
class OMNIMAP_API OmniMapD3D11 : public OmniMapBase
{
public:
	/**
	 ...
	 */
	OmniMapD3D11(int _resW, int _resH, ID3D11Device *_d3dDevice, ID3D11DeviceContext *_d3dDeviceContext,
		const char* strStartUpScriptFile = "OmniMapD3D11Config/omnimap_startup.lua",
		const char *luaResDir = "OmniMapD3D11Config/Resources/",
		bool doInit = true);
  ...
  virtual void SetChannelD3D11DeviceContext(OmniMapChannelD3D11 *c, ID3D11DeviceContext *d3dDeviceContex);
  virtual void SetChannelD3D11DeviceContext(int i, ID3D11DeviceContext *d3dDeviceContex);
  virtual void SetChannelD3D11DeviceContext(const char * name, ID3D11DeviceContext *d3dDeviceContex);
  virtual void SetOmnimapD3D11DeviceContext(ID3D11DeviceContext *d3dDeviceContex);
	...
	void CreateTextureFromFile(ID3D11Device *d3dDevice, char *filename, ID3D11ShaderResourceView **shaderResView, 
								 ID3D11Texture2D **texture);
	void CreateTextureFromMemory(ID3D11Device *d3dDevice, unsigned char *textureData, int size, ID3D11ShaderResourceView **shaderResView, 
								 ID3D11Texture2D **texture);
