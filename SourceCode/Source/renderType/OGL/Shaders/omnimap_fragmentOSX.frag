		...
		for(int i = 0; i < MaxChannels; i++)	
		{
					...
					if (i == 0)
					{
						if (gl_TexCoord[0].w > 0.0)
						{
							...
							if (texCoords.s >= 0.0 && texCoords.s <= 1.0 &&
								...
								gl_FragColor.rgba = texture2D(channelTexture0, texCoords.st).rgba;
					...
					} else if (i == 1) 
					{
						if (gl_TexCoord[1].w > 0.0)
						{
							...
							if (texCoords.s >= 0.0 && texCoords.s <= 1.0 &&
								texCoords.t >= 0.0 && texCoords.t <= 1.0)
								gl_FragColor.rgba = texture2D(channelTexture1, texCoords.st).rgba;
								//gl_FragColor.rgba = vec4(texCoords.s, texCoords.t, 0.0, 1.0);
						}
					} else if (i == 2)
					{
						if (gl_TexCoord[2].w > 0.0)
						{
							...
							if (texCoords.s >= 0.0 && texCoords.s <= 1.0 &&
								texCoords.t >= 0.0 && texCoords.t <= 1.0)
								gl_FragColor.rgba = texture2D(channelTexture2, texCoords.st).rgba;
								//gl_FragColor.rgba = vec4(texCoords.s, texCoords.t, 0.0, 1.0);
						}
					} else if (i == 3)
					{
						if (gl_TexCoord[3].w > 0.0)
						{
							...
							if (texCoords.s >= 0.0 && texCoords.s <= 1.0 &&
								texCoords.t >= 0.0 && texCoords.t <= 1.0)
								gl_FragColor.rgba = texture2D(channelTexture3, texCoords.st).rgba;
						}
					}// else if (i == 4)
					//{
						//if (tc4.w > 0.0)
						//{
							...
							//if (texCoords.s >= 0.0 && texCoords.s <= 1.0 &&
								//texCoords.t >= 0.0 && texCoords.t <= 1.0)
								//gl_FragColor.rgba = texture2D(channelTexture4, texCoords.st).rgba;
						//}
					//} else if (i == 5)
					//{
						//if (tc5.w > 0.0)
						//{
							...
							//if (texCoords.s >= 0.0 && texCoords.s <= 1.0 &&
								//texCoords.t >= 0.0 && texCoords.t <= 1.0)
								//gl_FragColor.rgba = texture2D(channelTexture5, texCoords.st).rgba;
						//}
					//}
