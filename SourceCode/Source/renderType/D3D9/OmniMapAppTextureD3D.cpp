...
{
  name;
  return new OmniMapChannelATD3D(d3dDevice);
}
...
{
  EH_DECLARE;
	EH_Log("OmniMapChannelATD3D::Initialize %d %d (this rez is ignored, the application is required to provide its own channel texture)", xResolution, yResolution);
}
