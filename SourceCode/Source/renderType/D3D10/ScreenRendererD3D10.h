#ifndef __SCREEN_RENDERERD3D10__H
#define __SCREEN_RENDERERD3D10__H
...
private :
	...
	HRESULT CreateVertBuffers(ID3D10Device* pDev10, void* pVertices, int *NumVertices, int numShapes);
