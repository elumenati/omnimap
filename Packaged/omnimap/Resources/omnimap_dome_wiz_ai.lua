...
GLOBAL_channelResX = 2048
GLOBAL_channelResY = 2048
GLOBAL_clipNear = .1
GLOBAL_clipFar = 3000.0


SetOmnimapParameter("useSpoutInFinalPassCamera",false);
SetOmnimapParameter("useSpoutInRenderChannels",false);
