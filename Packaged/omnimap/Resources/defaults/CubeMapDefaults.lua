...
zLeftChannel= ClassRenderChannel:new("zLeft")
zLeftChannel:SetCameraInfo (90,1,.1,1000)

zRightChannel= ClassRenderChannel:new("zRight")
zRightChannel:SetCameraInfo (90,1,.1,1000)
